...
public Audio_Settings(id){
	...
	format(audio_menu, 1022, "\yМеню настроек звука\w^n ^n1. Воспроизводить все звуки %s^n2. Музыка при входе в игру %s^n3. Звук убийства первого игрока %s^n4. Звук убийства администратором %s^n5. Звук убийства девушкой %s^n6. Звук убийства игроком %s^n7. Звук когда 1 на 1 %s^n8. Далее^n9. Назад^n0. Сохранить и выйти",
...
public Audio_Settings1(id){
	new audio_menu1[1023]
	new onoff[2][]={{"\rвыкл\w"},{"\yвкл\w"}} // \r=red \y=yellow \w white
	format(audio_menu1, 1022, "\yМеню настроек звука\w^n ^n1. Звук один против толпы %s^n2. Звук убийства с ножа админом %s^n3. Звук убийства с ножа игроком %s^n4. Звук убийства с гранаты %s^n5. Звук самоубийства с гранаты %s^n6. Звук убийцы в голову %s^n7. Звук для убитого в голову %s^n8. Далее^n9. Назад^n0. Сохранить и выйти",
...
public Audio_Settings2(id){
	new audio_menu2[1023]
	new onoff[2][]={{"\rвыкл\w"},{"\yвкл\w"}} // \r=red \y=yellow \w white
	format(audio_menu2, 1022, "\yМеню настроек звука\w^n ^n1. Звук двойного убийства %s^n2. Звук нового раунда %s^n3. Звук множественного убийства %s^n4. Звук поднятой бомбы %s^n5. Таймер бомбы %s^n6. Звук в конце раунда %s^n9. Назад^n0. Сохранить и выйти",
