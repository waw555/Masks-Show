...
define("_BYTES", "bytes");
define("_MB", "MB");
define("_SUCCESS", "Нет ошибок");
define("_ERROR_MYSQL", "Пожалуйста, обновите вашу версию MySQL до MySQL 4.1 или выше.");
define("_ERROR_PHP", "Пожалуйста, обновите версию PHP до PHP 4.4.4 или выше.");
define("_ERROR_REG_GLOBALS", "Пожалуйста, отключите register_globals");
define("_ERROR_MAGIC_QUOTES", "Пожалуйста, отключите magic_quotes");
define("_ERROR_GMP", "Пожалуйста, включите bcmath и gmp.");
// updated keys; ShadesBot
// ban list details
define("_CHANGEDBANTIME","Изменено время бана на");
define("_CHANGEDBANREASON","Изменена причина бана на");
// live ban
define("_RCONPASSWORDNULL","Пароль RCON пустой!");
define("_SILENTBAN","Тихий бан (только добавляет бан в базу данных)");
define("_BANSELECTED","Забанить выбранных игроков");
define("_KICKSELECTED","Кикнуть выбранных игроков");
define("_BANSELECTEDCONFIRM","Вы действительно хотите забанить этих игроков?");
define("_KICKSELECTEDCONFIRM","Вы действительно хотите кикнуть этих игроков?");
define("_NOSELECTEDPLAYERS","Пожалуйста, выберите игроков!");
define("_CANNOTBANBOTS","Вы не можете банить ботов!");
// user level
define("_LEVELSAVEDLOGOUTREQUIRED", "Уровень сохранён. Пожалуйста, выйдите из системы и войдите снова, чтобы изменения вступили в силу.");
//new design related
define("_DOWNLOADPLUGINS", "Скачать плагины для сервера");
define("_SOURCEDOESNOTEXIST", "Каталог с плагинами не существует");
define("_DESTINATIONNOTWRITABLE", "Каталог недоступен для записи");
define("_ZIPCREATIONFAILED", "Не удалось создать zip-файл");
// reasons
define("_DEFAULTBANSET", "Установить причиной по умолчанию");
//settings
define("_EMAILSETTINGS", "Настройки электронной почты");
define("_EMAILHOST", "Адрес сервера");
define("_EMAILHOSTPORT", "Порт");
define("_EMAILSECURITY", "Безопасность");
define("_EMAILSTARTTLS", "STARTTLS");
define("_EMAILSMTPS", "SMTPS");
define("_EMAILINSECURE", "Нет");
define("_EMAILUSERNAME", "Логин");
define("_EMAILPASSWORD", "Пароль");
define("_EMAILFROM", "Почта отправителя");
define("_EMAILFROMNAME", "Имя отправителя");
define("_TESTEMAIL", "Проверить подключение");
define("_TESTEMAILRECIPIENT", "Отправить тестовое письмо");
?>